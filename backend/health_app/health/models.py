...
class UserHealthProfile(models.Model):
    ...
    heart_rate=models.IntegerField(default=75 ,null=True,blank=True)
    respiratory_rate=models.IntegerField(default=16 ,null=True,blank=True)
    body_temperature=models.FloatField(default=36.8 ,null=True,blank=True)
    pulse_oximetry=models.IntegerField(default=98 ,null=True,blank=True)
    bmi_percentile=models.IntegerField(default=0 ,null=True,blank=True)
    ...
    is_heart_rate_selling=models.BooleanField(default=False)
    is_respiratory_rate_selling=models.BooleanField(default=False)
    is_body_temperature_selling=models.BooleanField(default=False)
    is_pulse_oximetry_selling=models.BooleanField(default=False)
    is_bmi_percentile_selling=models.BooleanField(default=False)
