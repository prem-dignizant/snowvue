...
class BuyerConsumer(AsyncWebsocketConsumer):
    async def connect(self):
        ...
        self.room_name = 'agriculture_data_buyer'
        self.room_group_name = 'agriculture_data_buyer_group'
        if token:
            try:
...
class SellerConsumer(AsyncWebsocketConsumer):
    async def connect(self):
        ...
        self.room_name = 'agriculture_data_seller'
        self.room_group_name = 'agriculture_data_seller_group'
        if token_header:
            try:
